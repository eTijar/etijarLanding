...
you can download <span className='text-secondary'>eTijar</span> on Google Play or the App Store.</p>
                <div className='w-1/2 flex md:justify-between justify-center items-center md:flex-nowrap flex-wrap mt-16'>
                    <Link href='/'><img className='w-32 mb-2 cursor-pointer' src='/googlePlay.png' alt='googleplay' /></Link>
                    <Link href='/'><img className='w-32 cursor-pointer' src='/appStore.png' alt='appStore' /></Link>
                </div>
        </div>
			...
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8 xl:col-span-1">
						<img className="h-10" src="/logo.png" alt="Etijar" />
